...
*/
	...
	Print<<round6(ExpRes.GetRecallAvg())<< " "<< round6(ExpRes.GetRdeAvg())<<" "<< round6(ExpRes.GetQueryTimeAvg()/config.GetQueryToRunQty()) <<" "<< round2(ExpRes.GetIndexTimeAvg())<<" "<< round2(ExpRes.GetMemAvg())<<" "<<MethParamStr<<" "<< endl;

    cout.setf(ios::fixed);
	cout<<round6(ExpRes.GetRecallAvg())<< " "<< round6(ExpRes.GetRdeAvg())<<" "<< round6(ExpRes.GetQueryTimeAvg()/config.GetQueryToRunQty()) <<" "<< round2(ExpRes.GetIndexTimeAvg())<<" "<< round2(ExpRes.GetMemAvg())<<" "<<MethParamStr<<" "<< endl;
