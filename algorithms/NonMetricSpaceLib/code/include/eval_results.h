...
public:
  ...
  double GetMAP()          const { return MAP_; }
  double GetRde()          const { return Rde_; }
  double GetMrr()          const { return Mrr_; }
  double GetDcg()          const { return Dcg_; }
    /*
...
private:
  ...
  void ComputeMetrics(LabelType queryLabel) {
	...
	MAP_               = EvalMAP<dist_t>()(ExactResultSize, SortedAllEntries_, ExactResultIds_, ApproxEntries_, ApproxResultIds_);

	Rde_               = EvalRde<dist_t>()(ExactResultSize, SortedAllEntries_, ExactResultIds_, ApproxEntries_, ApproxResultIds_);

	Mrr_               = EvalMrr<dist_t>()(ExactResultSize, SortedAllEntries_, ExactResultIds_, ApproxEntries_, ApproxResultIds_);

	Dcg_               = EvalDcg<dist_t>()(ExactResultSize, SortedAllEntries_, ExactResultIds_, ApproxEntries_, ApproxResultIds_);
