...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/yzhang4/HD/home/liwen/Downloads/Dataset/%s/exp_fig/result/HKMeans/k=%d/%diteration_%dbranches.txt",file_path,nn,iteration,branches);
	...
	char index_path[100];
	sprintf(index_path, "../../hkmeans/%s/%diteration_%dbranches.index",data_name,iteration,branches);                                                                   
