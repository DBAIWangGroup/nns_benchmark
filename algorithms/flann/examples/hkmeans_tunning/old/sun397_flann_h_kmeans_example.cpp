...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/liwen/Downloads/Dataset/SUN397/exp_fig/result/Flann/flann_HKMeans_%dbranches.txt",branches[b]);
	...
	char index_path[100];
	sprintf(index_path, "hkmeans/sun_HKMeans_indices_%dbranches",branches[b]);
