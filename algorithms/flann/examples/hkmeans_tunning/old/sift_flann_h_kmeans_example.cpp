...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/liwen/Downloads/Dataset/SIFT1M/sift/exp_fig/result/Flann/flann_HKMeans_%dbranches.txt",branches[b]);
    ...
    out<<"#Algorithm = H_KMeans  Centroids_count ="<<branches[b]<<" iterations=20 cb_index = 0.4"<<endl;
    out<< index_time <<" #index_time "<<endl;
            
	char index_path[100];
	sprintf(index_path, "hkmeans/sift_HKMeans_indices_%dbranches",branches[b]);
