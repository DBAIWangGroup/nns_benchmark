...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/liwen/Downloads/Dataset/GIST1M/gist/exp_fig/result/Flann/flann_HKMeans_%dbranches.txt",branches[b]);
	...
	char index_path[100];
	sprintf(index_path, "hkmeans/gist_HKMeans_indices_%dbranches",branches[b]);
