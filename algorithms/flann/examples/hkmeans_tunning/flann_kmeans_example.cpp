...
int main(int argc, char** argv)
{
	...
	while (iarg != -1) {
    iarg = getopt_long(argc, argv, "f:d:i:k:b:h",longopts, &id);
	...
	char data_path[100];
	sprintf(data_path,"/home/yzhang4/HD/home/liwen/Downloads/Dataset/%s/data/dataset.hdf5",file_path);
	...
	sprintf(result_path,"/home/yzhang4/HD/home/liwen/Downloads/Dataset/%s/exp_fig/result/HKMeans/KMeans/%diteration_%dbranches.txt",file_path,iteration,branches);
	...
	char index_path[100];
	sprintf(index_path, "../../kmeans/%s/%diteration_%dbranches.index",data_name,iteration,branches);                                                                   
    index.save(index_path); 

    // do a knn search, using 128 chec
    int checks[15]={100,200,300,500,700,1000,1500,2000,3000,4000,5000,7000,10000,15000,20000}; 
    for(int c=0;c<15;c++)
    {
