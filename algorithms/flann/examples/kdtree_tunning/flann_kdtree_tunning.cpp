...
int main(int argc, char** argv)
{
	...
	while (iarg != -1) {
    iarg = getopt_long(argc, argv, "f:d:k:t:h",longopts, &ind);
	...
	sprintf(result_path,"/home/yzhang4/HD/home/liwen/Downloads/Dataset/%s/exp_fig/result/KDTree/k=%d/%dtrees.txt",file_path,nn,trees);
    ...
    sprintf(index_path,"../../kdtree/%s/%dtrees.index",data_name,trees);
