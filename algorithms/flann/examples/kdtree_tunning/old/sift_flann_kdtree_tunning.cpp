...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/liwen/Downloads/Dataset/SIFT1M/sift/exp_fig/result/Flann/flann_KDTree_%dtrees.txt",trees[t]);
    ...
    char index_path[100];
    sprintf(index_path,"kdtree/sift_KDTree_indices_%dtrees",trees[t]);       
