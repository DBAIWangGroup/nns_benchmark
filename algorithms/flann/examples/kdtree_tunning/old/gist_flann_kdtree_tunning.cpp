...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/liwen/Downloads/Dataset/GIST1M/gist/exp_fig/result/Flann/flann_KDTree_%dtrees.txt",trees[t]);
    ...
    char index_path[100];
    sprintf(index_path,"kdtree/gist_KDTree_indices_%dtrees",trees[t]);                                                             
