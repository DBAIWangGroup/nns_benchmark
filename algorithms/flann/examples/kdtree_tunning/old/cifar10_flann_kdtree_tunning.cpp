...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/liwen/Downloads/Dataset/CIFAR/exp_fig/result/Flann/flann_KDTree_%dtrees.txt",trees[t]);
    ...
    out<<"#Algorithm = KDTree trees="<<trees[t]<<endl;
    out<< index_time <<" #index_time "<<endl;                                                               
    
  	char index_path[100];
    sprintf(index_path,"kdtree/cifar10_KDTree_indices_%dtrees",trees[t]);                                                             
