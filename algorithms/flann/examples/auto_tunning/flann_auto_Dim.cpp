...
int main(int argc, char** argv)
{
	...
	{"suf_name",                    required_argument, 0, 'l'},
	...
	while (iarg != -1) {
    iarg = getopt_long(argc, argv, "f:d:l:b:m:t:s:k:h",longopts, &ind);
	...
	char file_name[100];
	sprintf(file_name,"/home/yzhang4/HD/home/liwen/Downloads/Dataset/%s/data/dataset%s.hdf5",file_path,suf_name);
	...
	sprintf(result_path,"/home/yzhang4/HD/home/liwen/Downloads/Dataset/%s/exp_fig/result/Auto/k=%d/%s_%.2fPrecision_%.2fBuild_%.0fMemory.txt",file_path,nn,data_name,target_precision,build_weight,memory_weight);
