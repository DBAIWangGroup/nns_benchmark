...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/yzhang4/HD/home/liwen/Downloads/Dataset/%s/exp_fig/result/Auto/k=%d/%.2fPrecision_%.2fBuild_%.0fMemory.txt",file_path,nn,target_precision,build_weight,memory_weight);
    out.open(result_path,ios::app);
    
	sample_fraction = 0.1; //1000.0/dataset.rows; // 0.1; //
