...
int main(int argc, char** argv)
{
	...
	sprintf(result_path,"/home/liwen/Downloads/Dataset/Glove/exp_fig/result/Flann/flann_Auto_%.2fPrecision_%.2fBuild_%.0fMemory.txt",target_precision,build_weight,memory_weight);
    ...
    */
	...
	cout<<"glove target:"<<target_precision<<" build_weight:"<<build_weight<<" memory_weight:"<<memory_weight<<" \n";
	...
	char index_path[100];
	sprintf(index_path,"auto/glove_Auto_indices_%.2fPrecision_%.2fBuild_%.0fMemory",target_precision,build_weight,memory_weight);                                                                       
...
*/
	...
	sprintf(indices_path,"/home/liwen/Downloads/Dataset/Glove/result/Auto_result_%.2fPrecision_%.2fBuild_%.0fMemory.hdf5",target_precision,build_weight,memory_weight);
