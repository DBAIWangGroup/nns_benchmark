...
int main(int argc, char** argv)
{
    ...
    load_from_file(groundtruth,"/home/liwen/Downloads/Dataset/Youtube_Faces/data/dataset.hdf5","groundtruth");
	...
	sprintf(result_path,"/home/liwen/Downloads/Dataset/Youtube_Faces/exp_fig/result/Flann/flann_Auto_%.2fPrecision_%.2fBuild_%.0fMemory.txt",target_precision,build_weight,memory_weight);
    ...
    */
	...
	cout<<"youtube target:"<<target_precision<<" build_weight:"<<build_weight<<" memory_weight:"<<memory_weight<<" \n";
	...
	char index_path[100];
	sprintf(index_path,"auto/youtube_Auto_indices_%.2fPrecision_%.2fBuild_%.0fMemory",target_precision,build_weight,memory_weight);                                                                       
...
*/
	...
	sprintf(indices_path,"/home/liwen/Downloads/Dataset/Youtube_Faces/result/Auto_result_%.2fPrecision_%.2fBuild_%.0fMemory.hdf5",target_precision,build_weight,memory_weight);
