...
int main(int argc, char * argv[]) {
	const struct option longopts[] ={
	  ...
	  //read query
	  DistData** query=new DistData*[nq];
	  ...
	  float rde = compute_relative_distance_error(gnd, points, query, distances,nq, nn, dim,nums);

	  out<<recall<<" "<<rde<<" "<<search_time<<" #N_"<<checks/nq<<" "<<endl;
}
